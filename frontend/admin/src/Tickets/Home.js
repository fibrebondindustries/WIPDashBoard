...
//   useEffect(() => {
//     fetchTickets();
//   }, [user]); // Fetch tickets when user data changes
...
//             <div className="card p-3 mb-3" style={{ backgroundColor: "aliceblue" }}>
...
//                   className="form-control me-2"
//                 />
//                 <button className="btn btn-success me-2"  onClick={() => window.location.reload()}>Reset⟳
//                 </button>
//               </div>
//             </div>
...
//                         <td>{ticket.Status}</td>
//                         <td>
//                             {new Date(ticket.RaiseDate).toLocaleDateString("en-GB", {
//                               day: "2-digit",
//                               month: "2-digit",
//                               year: "numeric",
//                             })}
